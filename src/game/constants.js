...
// ═══════════════════════════════════════════════════════════════
// ⚠️ MODO TESTE — TEMPORÁRIO — pagamentos turbinados pra você
// sentir os 10 jogos pagando mais durante os testes em demo.
//
// TODOS os jogos multiplicam o prêmio final por este número.
// Antes de ligar o PIX real, MUDE PARA 1 (ou apague esta linha
// e as referências a TEST_MODE_PAYOUT_BOOST em cada jogo).
// Só esse número controla tudo — não precisa caçar em 10 arquivos.
// ═══════════════════════════════════════════════════════════════
